...
class _HomepageState extends State<Homepage> {
  ...
  Future<void> GetAddressFromLatLong(Position position)async {
    ...
    for(Placemark p in placemarks){
      print("${p.name},${p.street},${p.isoCountryCode},${p.country},${p.postalCode},${p.administrativeArea},${p.subAdministrativeArea},${p.locality},${p.subLocality},${p.thoroughfare},${p.subThoroughfare}");
    }
